        ...
        <div className=' w-full flex items-center px-4 lg:flex-row relative flex-col lg:px-12 py-14 ' >
            ...
            <div className=' w-full relative flex justify-center lg:mt-0 mt-8 ' >
                ...
                <div className=' lg:max-w-lg ' > 
                    <p className=' text-3xl lg:text-5xl leading  font-bold ' >Get <span className=' text-[#8C43FE] ' >Priority </span> Access!</p> 
                    <p className=' my-4 ' > Be the first to know when Hiroek goes live!</p>
                    <button className=' w-full mt-4 py-3 text-white bg-[#0B0D39] font-medium rounded-[43px] rounded-bl-[12px] ' >Get Access</button>
                </div>
